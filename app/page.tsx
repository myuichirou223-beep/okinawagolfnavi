  ...
  const featureSlides = [
    {
      ...
      mobileImageUrl: "/assets/hero/top-hero-golf-info-mobile.png",
    ...
    },
    {
      ...
      mobileImageUrl: "/assets/hero/top-hero-ad-recruit-mobile.png",
      tone: "blue" as const,
    ...
    },
    {
      ...
      mobileImageUrl: "/assets/hero/top-hero-responsive-site-mobile.png",
      tone: "orange" as const,
      actions: [],
      artwork: true,
